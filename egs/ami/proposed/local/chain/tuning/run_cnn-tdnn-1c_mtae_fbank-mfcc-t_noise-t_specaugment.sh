...
if $use_ihm_ali; then
  ...
  dir=exp/$mic/chain${nnet3_affix}/train_from_scratch/CNN_TDNN_1C/FSFAE3/DEFAULT/SPECAUG/feam_mtlae_fbank-mfcc-t_noise-t_interpolation/${argu_desc}
...
if [ $stage -le 15 ]; then
  ...
  combine-feature-maps-layer name=combine_inputs input=Append(spec-augment, ivector-batchnorm, info-dae-dspae-batchnorm) num-filters1=1 num-filters2=5 num-filters3=2 height=40
